...
@interface OceaniaViewController6 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:OCEANIA pardic:nil requesttype:requestGET finish:^(NSData *data) {
