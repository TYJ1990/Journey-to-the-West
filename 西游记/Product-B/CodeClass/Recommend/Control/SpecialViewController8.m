...
@interface SpecialViewController8 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:SPECIAL pardic:nil requesttype:requestGET finish:^(NSData *data) {
