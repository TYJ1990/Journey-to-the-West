...
@interface NewViewController1 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:LATEST pardic:nil requesttype:requestGET finish:^(NSData *data) {
