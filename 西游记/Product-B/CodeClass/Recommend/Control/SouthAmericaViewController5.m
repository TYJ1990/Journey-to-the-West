...
@interface SouthAmericaViewController5 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:SOUTHAMERICA pardic:nil requesttype:requestGET finish:^(NSData *data) {
