...
@interface ChinaViewController9 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:CHINESE pardic:nil requesttype:requestGET finish:^(NSData *data) {
