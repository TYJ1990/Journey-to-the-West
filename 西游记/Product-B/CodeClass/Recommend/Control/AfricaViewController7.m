...
@interface AfricaViewController7 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:AFRICA pardic:nil requesttype:requestGET finish:^(NSData *data) {
