...
@interface EuropeViewController3 ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
-(void)reloadDataSource{
    [RequestManager requestWithURLString:EUROPE pardic:nil requesttype:requestGET finish:^(NSData *data) {
